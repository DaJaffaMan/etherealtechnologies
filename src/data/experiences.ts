...
export const experiences: JobExperience[] = [
  ...
  },
  {
    ...
    skills: ['Java', 'Spring Boot', 'Angular', 'Legacy System Migration']
  },
  {
    ...
    skills: ['OLTP Databases', 'OLAP Systems', 'SQL', 'PostgreSQL']
  },
  {
    ...
    skills: ['TypeScript', 'React', 'NextJS', 'AWS', 'Terraform', 'Vercel']
  },
  {
    ...
    skills: ['GraphQL', 'Pulumi', 'Docker', 'AWS (Cloud Architecture)', 'GitLab']
  },
  {
    ...
    skills: ['React', 'GraphQL (Federated Supergraphs)', 'GCP (Cloud Architecture)', 'Tailwind CSS']
  },
  {
    ...
    skills: ['TypeScript', 'React', 'Serverless', 'AWS', 'PHP (Legacy Migration)']
  },
  {
    title: 'Fullstack Engineer',
    company: 'BJSS',
    ...
    skills: ['TypeScript', 'React', 'GraphQL', 'Cloud Architecture']
  },
  {
    title: 'Fullstack Engineer',
    company: 'BJSS',
    ...
    skills: ['TypeScript', 'React', 'Java', 'AWS', 'Agile Methodologies']
  },
  {
    title: 'Fullstack Engineer',
  ...
  },
  {
    ...
    skills: ['Java', 'Spring Boot', 'Elasticsearch', 'Microservices']
  },
  {
    ...
    skills: ['Java', 'Spring Boot', 'Kafka', 'Neo4J', 'Kubernetes']
  },
  {
    ...
    skills: ['Java', 'Business Intelligence', 'SQL', 'Data Warehousing']
  }
];
